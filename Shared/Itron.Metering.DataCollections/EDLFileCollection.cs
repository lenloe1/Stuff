...
namespace Itron.Metering.DataCollections
{
    ...
    /// </summary>
    public class EDLFileCollection: FileCollection
    {
        ...
        //  01/21/08 AF  10.0    N/A     Created 
        //
        public EDLFileCollection(string strDataDirectory)
        ...
        public void Refresh()
        {
            ...
            foreach (FileInfo objFile in objDir.GetFiles())
            {
				if (EDLFile.IsEDLFile(objFile.FullName))
                {
					try
					{
						...
						objEDLFile = new EDLFile(objFile.FullName);
            ...
            //Sort list
            IComparer myComparer = new EDLFileComparer();
    ...
    //  01/21/08 AF  10.0    N/A     Created 
    //
    public class EDLFileComparer : IComparer
    {
