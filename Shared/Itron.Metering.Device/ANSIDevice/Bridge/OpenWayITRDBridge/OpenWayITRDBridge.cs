...
namespace Itron.Metering.Device
{
    ...
    /// </summary>
    public partial class COpenWayITRDBridge : OpenWayITRD, IVoltMonitorCounts
    {
        #region Constants
        #endregion
        ...
        //
        public COpenWayITRDBridge(Itron.Metering.Communications.ICommunications ceComm)
            : base(ceComm)
        {
        ...
        //  11/27/13 jrf 3.50.10        Created
        //
        public COpenWayITRDBridge(CPSEM PSEM)
            : base(PSEM)
        {
            m_BridgeDevice = BridgeDevice.CreateBridgeDevice(m_PSEM, this);
        }
