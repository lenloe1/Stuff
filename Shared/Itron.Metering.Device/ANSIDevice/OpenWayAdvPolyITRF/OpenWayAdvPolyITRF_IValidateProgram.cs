...
{
    public partial class OpenWayAdvPolyITRF
    {
        ...
        //
        protected override void GetEnergyQuantityValidationItems(List<EDLValidationItem> ValidationList)
        {
            base.GetEnergyQuantityValidationItems(ValidationList);
