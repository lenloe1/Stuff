...
namespace Itron.Metering.Device
{
    ...
    /// </summary>
    public partial class CENTRON_AMI : IHANInformation
    {
        ...
        public virtual string HanModVer
        {
            get
            {
                return Table2108.HanModuleVersion;
            }
        }
        ...
        public virtual string HanModBuild
        {
            get
            {
                return Table2108.HanModuleBuild;
            }
        }
        ...
        public virtual string HanModType
        {
            get
            {
                return Table2108.HanModuleType;
            }
        }
        ...
        //  12/17/13 DLG 3.50.16        Moved from ANSIDevice to CENTRON_AMI.
        //
        public virtual float HanModFirmwareVersion
        {
            get
            {
                return Table2108.HANVersionOnly + Table2108.HANRevisionOnly / 1000.0f;
            }
        }
        ...
        //
        public virtual byte HANModFirmwareBuild
        {
            get
            {
                return Table2108.HANBuildOnly;
            }
        }
        ...
        public bool HANSupported
        {
            get
            {
                ...
                blnSupported = (true == Table00.IsTableUsed(2098) 
                             && true == Table00.IsTableUsed(2099)
                             && true == Table00.IsTableUsed(2100) 
                             && true == Table00.IsTableUsed(2102)
                             && true == Table00.IsTableUsed(2103) 
                             && true == Table00.IsTableUsed(2104));
        ...
        public bool HANEventsSupported
        {
            get
            {
                ...
                blnSupported = (true == Table00.IsTableUsed(2164) 
                    || (true == Table00.IsTableUsed(2242) && true == Table00.IsTableUsed(2243)));
        ...
        // 03/15/10 AF  2.40.25        Replaced FWBuild (LID request) with RegModBuild (table read)
        ...
        public virtual bool IsC1218OverZigBeeEnabled
        {
            get
            {
                ...
                // We started supporting this bit in FW 2.5.56
                if ((VersionChecker.CompareTo(FWRevision, VERSION_2_SP5) > 0)
                    || ((VersionChecker.CompareTo(FWRevision, VERSION_2_SP5) == 0)
                    && (Convert.ToInt32(RegModBuild, CultureInfo.InvariantCulture) >= 56)))
                {
                    bEnabled = (null != m_HANInfo) && m_HANInfo.IsC1218OverZigBeeEnabled;
                }
                else
                {
                    // C12.18 over ZigBee was always enabled prior to this.
                    bEnabled = true;
                }
        ...
        // MM/DD/YY who Version Issue# Description
        // -------- --- ------- ------ -----------------------------------------------------------------
        // 10/06/09 MMD 2.30.07 141872    Created
        // 11/11/09 MMD 2.30.16           Changed the property as per the design 0- Enabled, 1-Disabled
        // 03/15/10 AF  2.40.25        Replaced FWBuild (LID request) with RegModBuild (table read)
        // 03/31/10 AF  2.40.31         Renamed Table 2193 IsZigBeePrivateProfileEnabled to IsZigBeePrivateProfileDisabled
        //                              so that the logic is more intuitive. Also made virtual
        // 05/09/14 jrf 3.50.91 504003 Made part of IHANInformation interface
        public virtual bool IsZigBeePrivateProfileEnabled
        {
            get
            {
                ...
                if ((VersionChecker.CompareTo(FWRevision, VERSION_2_SP5) > 0)
                    ...
                    && (Convert.ToInt32(RegModBuild, CultureInfo.InvariantCulture) >= 56)))
                {
                    bEnabled = (null != m_HANInfo) && m_HANInfo.IsZigBeePrivateProfileEnabled;
                }
                else
                {
                    // it was always enabled prior to this.
                    bEnabled = true;
                }
        ...
        // 11/11/09 MMD 2.30.16           Changed the property as per the design 0- Enabled, 1-Disabled
        // 03/15/10 AF  2.40.25        Replaced FWBuild (LID request) with RegModBuild (table read)
        // 03/31/10 AF  2.40.31        Renamed IsZigBeeEnabled to IsZigBeeDisabled to make the logic
        //                             more intuitive.  Also made virtual
        // 05/09/14 jrf 3.50.91 504003 Made part of IHANInformation interface
        ...
        //  MM/DD/YY Who Version  ID Number  Description
        //  -------- --- -------  -- ------  --------------------------------------------
        //  03/16/16 AF  4.50.236 WR 606791  Created
        //  09/15/16 jrf 4.70.18  WI 713982  Moved here to make part of interface.
        public virtual byte HANAppVersion
        {
            get
            {
                ...
                if(null != Table2108 && null != Table2108.HANAppVersionOnly)
                {
                    Version = Table2108.HANAppVersionOnly.Value;
                }
        ...
        public virtual byte HANAppRevision
        {
            get
            {
                ...
                if (null != Table2108 && null != Table2108.HANAppRevisionOnly)
                {
                    Revision = Table2108.HANAppRevisionOnly.Value;
                }
        ...
        public virtual byte HANAppBuild
        {
            get
            {
                ...
                if (null != Table2108 && null != Table2108.HANAppBuildOnly)
                {
                    Build = Table2108.HANAppBuildOnly.Value;
                }
