...
namespace Itron.Metering.Device
{
    ...
    /// </summary>
    internal class OpenWayMFGTable2082 : AnsiTable
    {
        #region Constants
        ...
        // -------- --- ------- ------ ---------------------------------------
        // 04/06/10 MA  2.40.31 N/A    Created

        public OpenWayMFGTable2082(CPSEM psem)
            : base(psem, 2082, TABLE_SIZE, TABLE_TIMEOUT)
        {
        }
        ...
        public override PSEMResponse Read()
        {
            ...
            m_Logger.WriteLine(Logger.LoggingLevel.Detailed, "OpenWayMFGTable2082.Read");
        ...
        {
            m_byKey = m_Reader.ReadBytes((int)TABLE_SIZE);
        }
