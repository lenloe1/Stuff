...
namespace Itron.Metering.Datafiles
{
    ...
    public class CRFAncillaryrDataType : CRFDataType
    {
        ...
        //  -------- --- -------  ------    -------------------------------------------
        //  05/27/15 PGH 4.50.125 RTT556298 Created
        //  11/30/16 AF  4.70.38  WR730665  The IsRegister item must be set to true for compatibility with
        //                                  MV90 and IEE.
        //
    ...
    /// <summary>
    /// Instantaneous Current Data Record
    /// </summary>
    //  Revision History	
    //  MM/DD/YY Who Version  Issue#    Description
    //  -------- --- -------  ------    -------------------------------------------
    ...
    //
    public class InstantaneousCurrentDataRecord
    {
        ...
        /// Constructor
        /// </summary>
        public InstantaneousCurrentDataRecord()
        {
            m_ReadingTime = DateTime.MinValue;
            m_dblValue = 0.0;
            m_strDescription = "";
