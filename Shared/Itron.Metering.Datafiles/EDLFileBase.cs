...
namespace Itron.Metering.Datafiles
{
    ...
    public enum DaysOfWeek
      ...
      public enum EDLDeviceTypes
      {
          ...
          M2GatewayDevice,
          /// <summary>
          /// Device is a MAX Image meter.
          /// </summary>
          CentronII,
          /// <summary>
          /// Device is a MAX Image Basic Polyphase meter.
          /// </summary>
          CentronIIBasicPoly,
          /// <summary>
          /// Device is a MAX Image Advanced Polyphase meter.
          /// </summary>
          CentronIIAdvancedPoly,
      }*/
    ...
    /// </summary>
    public abstract class EDLFileBase
    {
        #region Constants
        ...
        //
        public EDLFileBase(string FileName)
        {
        ...
        //
        protected void SetSTDEDLString(String strValue, StdTableEnum StdTableEnumValue)
        {
...
#if (!WindowsCE)
            else if (m_GatewayTables.IsCached((long)stdTableEnum, null))
            {
                m_GatewayTables.GetValue(stdTableEnum, null, out Value);
                usTemp = ushort.Parse(Value.ToString(), NumberStyles.Integer, CultureInfo.CurrentCulture);
            }
#endif
...
#if (!WindowsCE)
        /// <summary>
        /// Stores the tables from the EDL file for an M2 Gateway meter
        /// </summary>
        ...
        private M2_Gateway_EventDictionary m_GWEventDictionary;
