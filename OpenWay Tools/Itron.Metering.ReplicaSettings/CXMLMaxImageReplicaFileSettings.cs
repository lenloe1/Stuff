...
namespace Itron.Metering.ReplicaSettings
{
    ...
    /// </summary>
    public class CXMLMaxImageReplicaFileSettings : Itron.Metering.ReplicaSettings.CXMLReplicaFileSettings
    {
        #region Constants
		
		private const string REPLICA_REG_KEY = "Replica";
        private const string XML_REPLICA_FILE_NAME = "SystemSettings.xml";
		private const string XML_SETTINGS_TAG = "CentronIIReplicaSettings";
		...
		//  
		public CXMLMaxImageReplicaFileSettings(string strFilePath)
			: base()
		{
